...
jQuery(document).ready(function(o){var a=o("body"),e=o(".me"),n=o(".contact__content__open-details"),t=o(".information__content__close");o(e).on("click",function(){o(a).addClass("overlay-active")}),o(n).on("click",function(e){e.preventDefault(),o(a).addClass("overlay-active")}),o(t).on("click",function(){o(a).removeClass("overlay-active")}),o(document).on("keyup",function(e){27==e.keyCode&&o(a).removeClass("overlay-active")}),jQuery(".owl-carousel").owlCarousel({loop:!0,margin:10,nav:!0,navText:["<i class='fa fa-arrow-left'></i>","<i class='fa fa-arrow-right'></i>"],responsive:{0:{items:1},600:{items:1},1e3:{items:1}}}),jQuery(document.documentElement).keyup(function(e){var o=jQuery(".owl-carousel");37==e.keyCode?(console.log("Go left"),o.trigger("prev.owl.carousel",[300])):39==e.keyCode&&(console.log("Go right"),o.trigger("next.owl.carousel"))})});