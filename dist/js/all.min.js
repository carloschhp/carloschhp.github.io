...
jQuery(document).ready(function(o){var n=o("body"),e=o(".me"),c=o(".information__content__close");o(e).on("click",function(){o(n).addClass("overlay-active")}),o(c).on("click",function(){o(n).removeClass("overlay-active")}),o(document).on("keyup",function(e){27==e.keyCode&&o(n).removeClass("overlay-active")})});